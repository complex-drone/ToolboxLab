export default {
  ...
  categories: {
    ...
    list: {
      ...
      datetime: { name: '日期时间与计算器' },
      regextools: { name: '正则与文本可视化' },
      charts: { name: '图表与数据可视化' },
      devops: { name: 'DevOps 与配置生成' },
      schema: { name: '数据格式与 Schema' },
      design: { name: '设计与字体' },
      webadv: { name: '浏览器与网络高级' },
      codesec: { name: '代码处理与安全' },
      devices: { name: '硬件与设备交互' },
      misc: { name: '杂项增强' },
    },
  },
